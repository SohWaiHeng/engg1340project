...
g. Player avatar:
	...
	b. In a battle, whenever a card is played, the elixir costs used to play the cards will accumulate, and we will call this accumulation 'meter'.
	c. When the meter is full, for example 25, the player will be able to draw a card from one of the avatar's cards.
	d. These 5 cards usually provides insane values and can help the player to get an upper hand in the battle. (eg: 0 elixir cost, area 3 shields and area thorns for 3 turns)
